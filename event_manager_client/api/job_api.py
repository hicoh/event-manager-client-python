...
class JobApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_source_job(
            self,
            **kwargs
        ):
            """Trigger a job to be sent to the source  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_source_job(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                organisation_id (str): [optional]
                source_job_request (SourceJobRequest): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.create_source_job = _Endpoint(
            settings={
                'response_type': (AsyncResponse,),
                'auth': [
                    'apikey'
                ],
                'endpoint_path': '/event_manager/job/source',
                'operation_id': 'create_source_job',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
